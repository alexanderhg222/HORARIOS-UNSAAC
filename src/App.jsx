    ...
    <div className="min-h-screen bg-gray-100 flex flex-col items-center py-10">
      <div className="w-full max-w-xl bg-white rounded-lg shadow p-8 space-y-6">
        ...
        <div className="flex flex-col gap-4">
          ...
          {loading && <FullScreenLoader message="Cargando carreras..." />}
          {!loading && (
            <select
        ...
        <div className="flex flex-col gap-4">
          ...
          <label className="font-semibold">Ejm:   149657 <span className='text-red-500 font-bold'>/ O PUEDES PONER/ </span>  HUAMAN-PEREZ-ANASTACIO</label>
          <input
            className="border rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400"
            type="text"
